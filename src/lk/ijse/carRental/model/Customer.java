...
public class Customer {
    ...
    public Customer(String cust_Id, String cust_Name, String cust_Address, String cust_NIC, String cust_Driv_Lic, int cust_Mobile_Num) {
    ...
    public Customer(String cust_Id, String cust_Name, String cust_Address, String cust_NIC, String cust_Driv_Lic) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public Customer(String cust_Name, String cust_Address, String cust_NIC, String cust_Driv_Lic) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
