...
public class BookingDTO {
    ...
    private MakePayment allMakePayment;

    public BookingDTO() {
    }

    public BookingDTO(String book_Id, String cust_Id, String rent_Start_Date, String rent_End_Date, String vehicle_Id, String book_Type, String driver_Id, int current_Milege, MakePayment allMakePayment) {
        ...
        this.allMakePayment = allMakePayment;
    }
    ...
    public MakePayment getAllMakePayment() {
        return allMakePayment;
    }

    public void setAllMakePayment(MakePayment allMakePayment) {
        this.allMakePayment = allMakePayment;
    }
